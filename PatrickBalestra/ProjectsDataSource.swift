...
final class ProjectsDataSource {
    ...
    init() {
        let notesForWatch = Project(
            ...
            websiteLink: NSURL(string: "http://www.noteswat.ch")!,
            iTunesID: "973679652",
            date: "April 2015",
        ...
        let weightTracker = Project(
            ...
            websiteLink: NSURL(string: "http://www.patrickbalestra.com/WeightTracker")!,
            iTunesID: "935650952",
            date: "Februrary 2015",
        ...
        let minuto = Project(
            ...
            websiteLink: NSURL(string: "http://www.minuto.ch")!,
            iTunesID: "961415214",
            date: "February 2015",
        ...
        let reviews = Project(
            ...
            websiteLink: NSURL(string: "http://www.reviewsapp.io")!,
            iTunesID: "909620669",
            date: "August 2014",
        ...
        let notesForPebble = Project(
            ...
            websiteLink: NSURL(string: "http://www.patrickbalestra.com/PebbleNotes")!,
            iTunesID: "841925707",
            date: "March 2014",
        ...
        let contactsForPebble = Project(
            ...
            websiteLink: NSURL(string: "http://www.patrickbalestra.com/PebbleContacts")!,
            iTunesID: "889603734",
            date: "July 2014",
        ...
        let emergency = Project(
            ...
            websiteLink: NSURL(string: "http://www.patrickbalestra.com/emergency/index.html")!,
            iTunesID: "574170034",
            date: "February 2013",
